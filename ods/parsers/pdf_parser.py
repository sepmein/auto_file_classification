...
class PDFParser(BaseParser):
    ...
    def parse(self, file_path: Path) -> ParseResult:
        ...
        try:
            ...
            # 提取元数据
            metadata = self._extract_pdf_metadata(file_path) if self.extract_metadata else {}
    ...
    def _extract_title(self, text: str, file_name: str, metadata: Dict[str, Any]) -> Optional[str]:
        """
        提取文档标题
