...
class TestPathPlanner:
    ...
    def test_plan_file_path_error(self):
        ...
        # 模拟错误
        with patch.object(self.path_planner, '_determine_primary_path', side_effect=Exception("测试错误")):
            result = self.path_planner.plan_file_path(
                classification_result, original_path, file_metadata
            )
    ...
    def test_determine_primary_path(self):
        ...
        result = self.path_planner._determine_primary_path(category, original_path, metadata)
    ...
    def test_plan_link_paths(self):
        ...
        link_paths = self.path_planner._plan_link_paths(tags, primary_category, primary_path)
    ...
    def test_check_path_conflicts(self):
        ...
        conflict_info = self.path_planner._check_path_conflicts(target_path, original_path)
    ...
    def test_resolve_conflict_with_suffix(self):
        ...
        # 创建临时文件模拟冲突
        with tempfile.NamedTemporaryFile(dir='test_output/工作', suffix='.pdf', delete=False) as f:
            f.write(b'test')
            temp_file = f.name
    ...
    def test_create_directory_structure(self):
        ...
        path_plan = {
            ...
            'link_paths': [
                {
                    'link_path': 'test_output/项目A/链接/document.pdf'
                }
            ]
        }
